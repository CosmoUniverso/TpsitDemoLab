...
module.exports = async (req, res) => {
  ...
  // POST: revisione (solo admin pieno, non teacher)
  if (req.method === 'POST') {
    if (!isAdmin(user.user_status)) return err(res, 'I teacher non possono approvare/rifiutare', 403);
